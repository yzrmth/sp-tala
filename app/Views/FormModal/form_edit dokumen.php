<div class="modal fade" tabindex="-1" role="dialog" id="modal-edit-dokumen" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="" id="form-edit-dokumen" enctype="multipart/form-data">
                    <?= csrf_field() ?>
                    <input type="hidden" class="form-control" id="fk_jenis_dokumen" name="fk_jenis_dokumen" value="">
